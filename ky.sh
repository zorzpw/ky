...
Host='github.com/zorzpw/ky/blob/master/';export Host=$Host
...
# APP软件客服
echo
echo -n -e "请输入APP客服QQ [默认:88888888 ]"
read adminqq
if [ -z $adminqq ]
then
	adminqq=88888888
...
echo
echo -n -e "请输入密匙：[\033[32m 666\033[0m ]："
read key
if [[ $key == '666' ]]
then
	echo
...
# 快云开机自启脚本 请自行添加">>/Data/start.sh
  ...
  if [ $NowV != '4.13.7-1.el7.elrepo.x86_64' ];then
    ...
    elrepo='欢迎你使用快云VPN产品,如果你有Bug和好的建议反馈给我们'
  fi
fi
clear
echo -e "
